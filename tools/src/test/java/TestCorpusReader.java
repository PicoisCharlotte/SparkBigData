import com.sparkbigdata.tools.CorpusReader;
...
public class TestCorpusReader {
    ...
    public void testReader() {
        ...
        // last word
        Assert.assertTrue(words.contains("j’entrouvre"));
        // remove dots
        Assert.assertTrue(words.contains("c’est"));
        // first word
        Assert.assertTrue(words.contains("mieux"));
    }
